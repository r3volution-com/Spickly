	...
	?>
			...
			<div id="spick" style="display: <?php echo ($_GET["m"] == 3) ? "none" : "block"; ?>">
				...
				<div id="sidebar_photos">
					<div id="buttons_images">
						...
						<a value="Me gusta" style="position:relative;" onclick="like(<?php echo $user_row["member_id"];?>,<?php echo $row["id"];?>,1)"> <img src="resources/images/like.png" title="Me gusta"> </a>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				var options = {  
					requestTagsUrl: 'in_actions.php?a=eti&ac=get',  
					deleteTagsUrl: 'in_actions.php?a=eti&ac=del',  
					addTagUrl: 'in_actions.php?a=eti&ac=put',
					placeList: 'tagList',
					parametersForNewTag: {  
						name: {  
							parameterKey: 'name',  
